...
urlpatterns = patterns('androrm.downloads.views',
    ...
    url(r'^latest/zip/$', 'download_latest_source', name = 'download_latest_source'),
    ...
    url(r'^release/(?P<version>(\d+)(.(\d+))+)/source/$', 'download_version_source', name = 'download_version_source'),
)

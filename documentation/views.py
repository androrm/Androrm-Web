...
from androrm.documentation.models import ClassDescription
...
def models(request):
    ...
    return render_to_response('documentation/models/index.html',
                              locals(),
                              context_instance=RequestContext(request))
...
def queries(request):
    ...
    return render_to_response('documentation/queries/index.html',
                              locals(),
                              context_instance=RequestContext(request))
...
def installation(request):
    ...
    return render_to_response('documentation/installation/index.html',
                              locals(),
                              context_instance=RequestContext(request))

...
class ClassDescription(Description):
    ...
    descriptors = models.ManyToManyField("TypeDescriptor", through = "ClassDescriptor", blank = True)
...
class FunctionDescription(Description):
    ...
    params = models.ManyToManyField("ParamDescription", through = "Param", blank = True, null = True)
    descriptors = models.ManyToManyField("TypeDescriptor", through = "FunctionDescriptor", blank = True)
    returns = models.ForeignKey("Type", blank = True, null = True)
...
class Type(models.Model):
    name = models.CharField(max_length = 80)
    descriptors = models.ManyToManyField("TypeDescriptor", null = True, blank = True)
...
class TypeDescriptor(models.Model):
    name = models.CharField(max_length = 80)
    extends = models.CharField(max_length = 80, blank = True, null = True)
